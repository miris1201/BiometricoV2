...
class cUsers extends BD
{
    ...
    public function getAllReg( $rol ){
        ...
        if ($this->getFiltro() != ""){
            $condition = " AND CONCAT_WS(' ', U.nombre, U.apepa, U.apema) LIKE '%".$this->getFiltro()."%' 
                            OR usuario LIKE '%".$this->getFiltro()."%' ";
        }
        ...
        $query  = " SELECT id_usuario, 
                           ...
                           U.admin
                      FROM ws_usuario as U 
                        LEFT JOIN ws_rol R ON U.id_rol = R.id_rol
    ...
    public function getRegbyid(){
        $query = "  SELECT id_usuario, id_rol, usuario,  
    ...
    public function getRegbyPW( $data ){
