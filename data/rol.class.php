...
class cRol extends BD {
    ...
    public function getAllReg(){
        ...
        $query = " SELECT id_rol, rol, descripcion, activo
    ...
    public function getAllRoles(){
        ...
        $query = " SELECT id_rol, rol, descripcion
                     FROM ws_rol 
    ...
    public function parentsMenu(){
        $query = "  SELECT id_menu, id_grupo, texto, link  
                      FROM ws_menu
    ...
    public function getRegbyId( $id ){
        $query = "  SELECT id_rol, rol, descripcion, activo FROM ws_rol WHERE id_rol = ".$id;
        $result   = $this->conn->prepare($query);
        $result->execute();
        return $result;
    ...
    public function deleteReg(){
        $correcto   = 2;
        $delete     = "DELETE FROM ws_rol WHERE id_rol = ".$this->getId();
