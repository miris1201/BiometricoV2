                    ...
                    if ($showinfo == true) {   ?>
                        <div class="card">
                            <?php
                                ...
                                ?>
                            <div class="card-head" style="background-color: #31B189;">
                                <div class="tools pull-left">
                                    <a class="btn ink-reaction btn-floating-action" style="background-color: #FFC872;" href='<?php echo $raiz ?>?controller=business&action=show' title="Regresar al inicio">
                                        <i class="fa fa-arrow-left"></i>
                                    </a>
                                </div>
                                <b>Mi cuenta</b>
                                <div class="tools">
                                    <span class="<?php echo $class_activo ?>" title="Usuario Activo"></span>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-xs-12 col-md-12 col-sm-12">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group floating-label">
                                                            <input type="text" class="form-control" name="nombre" id="nombre" autocomplete="off" required value="<?php echo $nombre ?>" readonly>
                                                            <label for="nombre">Nombre(s)<span class="text-danger">*</span></label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group floating-label">
                                                            <input type="text" class="form-control" name="apepat" id="apepat" autocomplete="off" value="<?php echo $apepa ?>" readonly>
                                                            <label for="apepat">Apellido Paterno <span class="text-danger">*</span></label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group floating-label">
                                                            <input type="text" class="form-control" name="apemat" id="apemat" autocomplete="off" value="<?php echo $apema ?>" readonly>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group floating-label">
                                                            <input type="text" class="form-control" name="usuario" id="usuario" autocomplete="off" required value="<?php echo $usuario ?>" readonly>
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-4 col-xs-12 col-lg-4">
                                                        <button type="button" class="btn ink-reaction btn-block" style="background-color: #FFC872;" id="btn_cp" onclick="cpwModal()">
                                                            <i class="fa fa-key"></i>
                                                            Cambiar Contraseña
                                                        </button>
                                                    </div>
                    ...
                    <div class="modal-body">
                        <article id="container-info">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group floating-label">
                                        <input type="password" class="form-control validate" id="nuevaclave" name="nuevaclave" required>
