                    ...
                    <div class="card">
                        <div class="card-head style-success">
                            <div class="tools pull-left">
                                <a class="btn ink-reaction btn-floating-action btn-default-light" 
                        ...
                        <div class="card-body">
                            <form id="<?php echo $frmName ?>" class="form" role="form" method="post">
                                        ...
                                        <fieldset>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group floating-label">
                                                        <input type="text" class="form-control" 
                                                            ...
                                                            required value="<?php echo $nombre ?>" <?php echo $readOnly ?>>
                                                        <label for="nombre">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group floating-label">
                                                        <input type="text" class="form-control" 
                                                            ...
                                                            autocomplete="off" value="<?php echo $apepa ?>" <?php echo $readOnly ?>>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group floating-label">
                                                        <input type="text" class="form-control" 
                                                            ...
                                                            autocomplete="off" value="<?php echo $apema ?>" <?php echo $readOnly ?>>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-sm-3">
                                                    <div class="form-group floating-label">
                                                        <input type="text" class="form-control" 
                                                            name="usuario" id="usuario" autocomplete="off" required 
                                                            value="<?php echo $usuario ?>" <?php echo $readOnly ?>>
                                                ...
                                                <div class="col-sm-3" <?php echo $showInput ?>>
                                                    <div class="form-group floating-label">
                                                        <input type="password" class="form-control" name="clave" id="clave" autocomplete="off" <?php echo $readOnly ?>>
                                            ...
                                            <div class="row form-group">
                                                <?php
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group floating-label">
                                                            <select name="admin" id="admin" <?php echo $readOnly ?> class="form-control" required>
                                                                <option value=""></option>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group floating-label">
                                                        <select name="id_rol" id="id_rol" <?php echo $readOnly ?> class="form-control rol" required>
                                                            <option value=""></option>
                                                            <?php
                                                                $rs_rol = $cRoles->getAllRoles();
                                                                while ($rw_rol = $rs_rol->fetch(PDO::FETCH_OBJ)) {
                                                                    $sel = "";
                                                                    if ($id_rol == $rw_rol->id_rol) {
                                                                        $sel = "selected";
                                                                    }
                                                                    ?>
                                                                <option value="<?php echo $rw_rol->id_rol ?>" <?php echo $sel ?>>
                                                ...
                                                <div class="row">
                                                    <div class="permisos-field">
                                                        <div class="checkbox checkbox-styled">
                                                            <label>
                                                                <input name="ckSelectAll" id="ckSelectAll" type="checkbox" value="1" title="Imprimir Registros" <?php echo $readOnly ?>>
                                                            ...
                                                            <?php
                                                                if ($id > 0) {
                                                                    ...
                                                                    <div id="<?php echo $rowReg->id_menu ?>" class="parents-menu_<?php echo $rowReg->id_menu ?>">
                                                                        <div class="checkbox">
                                                                            <span id="mostrar_<?php echo $rowReg->id_menu ?>" class="btn-plus-ne mostrar">
                                                                                <i class="fa fa-plus-square-o"></i>
                                                                            </span>
                                                                            <span id="ocultar_<?php echo $rowReg->id_menu ?>" class="btn-plus-ne ocultar">
                                                                                <i class="fa fa-minus-square-o"></i>
                                                                            </span>
                                                                            <label> <input name="menus[]" id="menu_<?php echo $rowReg->id_menu ?>" type="checkbox" <?php echo $readOnly ?> value="<?php echo $rowReg->id_menu ?>" <?php echo $chk ?> title="<?php echo $rowReg->texto ?>"> <?php echo $rowReg->texto ?>
                                                                            </label>
                                                                        </div>
                                                                        <input type="hidden" id="grupo_m_<?php echo $rowReg->id_menu ?>" name="grupo[<?php echo $rowReg->id_menu ?>]" value="<?php echo $rowReg->id_grupo ?>">
                                                                    </div>
                                                                    ...
                                                                    <div id="child-menu_<?php echo $rowReg->id_menu ?>" class="child-menu">
                                                                        <?php
                                                                                    while ($rowReg_c = $rsRol_c->fetch(PDO::FETCH_OBJ)) {
                                                                                        ...
                                                                                        ?>
                                                                            <input type="hidden" id="grupo_m_<?php echo $rowReg_c->id_menu ?>" name="grupo[<?php echo $rowReg_c->id_menu ?>]" value="<?php echo $rowReg_c->id_grupo ?>">
                                                                            <div class="checkbox">
                                                                                <label class="separador-desc">
                                                                                    <input name="menus[]" id="child_<?php echo $rowReg->id_menu ?> _<?php echo $rowReg_c->id_menu ?>" type="checkbox" value="<?php echo $rowReg_c->id_menu ?>" title="<?php echo $rowReg_c->texto ?>" <?php echo $chk_2 ?> <?php echo $readOnly ?>>
                                                                                    <?php echo $rowReg_c->texto ?>
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_imp[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Imprimir" id="permiso_imp<?php echo $rowReg_c->id_menu ?>" <?php echo $readOnly ?> <?php if ($chk_imp == 1) {
                                                                                                                                                                                                                                                                                        echo "checked";
                                                                                                                                                                                                                                                                                    } ?>>
                                                                                    Imprimir
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_nuevo[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Nuevo" id="permiso_nuevo<?php echo $rowReg_c->id_menu ?>" <?php echo $readOnly ?> <?php if ($chk_nuevo == 1) {
                                                                                                                                                                                                                                                                                            echo "checked";
                                                                                                                                                                                                                                                                                        } ?>>
                                                                                    Nuevo
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_edit[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Editar" id="permiso_edit<?php echo $rowReg_c->id_menu ?>" <?php echo $readOnly ?> <?php if ($chk_edit == 1) {
                                                                                                                                                                                                                                                                                        echo "checked";
                                                                                                                                                                                                                                                                                    } ?>>
                                                                                    Editar
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_elim[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Eliminar" id="permiso_elim<?php echo $rowReg_c->id_menu ?>" <?php echo $readOnly ?> <?php if ($chk_elim == 1) {
                                                                                                                                                                                                                                                                                            echo "checked";
                                                                                                                                                                                                                                                                                        } ?>>
                                                                                    Eliminar
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_exportar[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Exportar" id="permiso_exportar<?php echo $rowReg_c->id_menu ?>" <?php echo $readOnly ?> <?php if ($chk_exportar == 1) {
                                                                                                                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                                                                                                                } ?>>
                                                                                    Exportar
                                                                                </label>
                                            ...
                                            <fieldset> <br>
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-4 col-xs-12 col-lg-4">
                                                        <button type="submit" class="btn ink-reaction btn-block" style="background-color: #FFC872;" id="btn_guardar">
                                                            <strong>
