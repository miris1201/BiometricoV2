...
include_once $dir_fc . 'data/sql/empleados.class.php';

$cInicial = new cInicial();
$cFn      = new cFunction();
$cLista   = new cEmpleados();
...
<head>
    <title>Empleados | <?php echo $titulo_paginas ?></title>
...
<body class="<?php echo _BODY_STYLE_ ?> ">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    <?php
                                                                                ...
                                                                                if (($_SESSION[admin]) || $_SESSION[id_rol] <= 2) {
                                                                                    ?>
                                                                        <a onclick="cpwModal(<?php echo $iId ?>)" 
                                                                            class="btn ink-reaction btn-icon-toggle" 
                                                                            data-toggle="tooltip" 
                                                                            data-placement="top" 
                ...
                <form role="form" id="idCPW" class="form">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="id_user_pw" name="id_user_pw" />
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group floating-label">
                                    <input type="password" class="form-control" name="nuevaclave" id="nuevaclave" required autocomplete="off" maxlength="16">
                            ...
                            <div class="col-md-6">
                                <div class="form-group floating-label">
                                    <input type="password" class="form-control" id="confclave" name="confclave" required autocomplete="off" maxlength="16">
                                    <label for="confclave">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link btn-danger" data-dismiss="modal">Cerrar
                        </button>
                        <button type="submit" id="btn_aceptar_cpw" class="btn bg-success ink-reaction">
                            Aceptar
                        </button>
                    </div>
                </form>
    ...
    <div class="modal small fade" id="idModalSearch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #31B189;">
                    <button type="button" class="close" data-dismiss="modal">×</button>
                ...
                <form role="form" id="frmSearch" class="form">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group floating-label">
                                    <input type="text" class="form-control dirty" name="txtBuscar" id="idSearch" autocomplete="off" />
                                    <label for="idSearch">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link btn-danger" data-dismiss="modal">
                            Cerrar
                        </button>
