                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group floating-label">
                                                            <input type="text" class="form-control" name="rol" id="rol" value="<?php echo $rol ?>" <?php echo $readOnly ?> required>
                                                            <label for="rol">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group floating-label">
                                                            <input type="text" class="form-control" name="descripcion" id="descripcion" value="<?php echo $descripcion ?>" <?php echo $readOnly ?> required>
                                                        ...
                                                        <article id="permisos">
                                                            <div class="permisos-field">
                                                                <div class="checkbox checkbox-styled">
                                                                    <label>
                                                                        <input name="ckSelectAll" id="ckSelectAll" type="checkbox" value="1" <?php echo $readOnly ?> title="Imprimir Registros">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    <div id="<?php echo $rowReg->id_menu ?>">
                                                                        <div class="checkbox checkbox-styled">
                                                                            <span id="btn_mostrar_<?php echo $rowReg->id_menu ?>" class="btn-plus-ne mostrar">
                                                                                <i class="fa fa-plus-square-o"></i>
                                                                            </span>
                                                                            <span id="btn_ocultar_<?php echo $rowReg->id_menu ?>" class="btn-plus-ne ocultar">
                                                                                <i class="fa fa-minus-square-o"></i>
                                                                            </span>
                                                                            <label>
                                                                                <input name="menus[]" id="menu_<?php echo $rowReg->id_menu ?>" type="checkbox" <?php echo $chk ?> <?php echo $readOnly ?> value="<?php echo $rowReg->id_menu ?>" title="<?php echo $rowReg->texto ?>">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            <div class="checkbox checkbox-styled">
                                                                                ...
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_imp[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Imprimir" <?php echo $readOnly ?> id="permiso_imp<?php echo $rowReg_c->id_menu ?>" <?php if ($chk_imp == 1) {
                                                                                                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                                                                                                } ?>>
                                                                                    Imprimir
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_nuevo[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Nuevo" <?php echo $readOnly ?> id="permiso_nuevo<?php echo $rowReg_c->id_menu ?>" <?php if ($chk_nuevo == 1) {
                                                                                                                                                                                                                                                                                        echo "checked";
                                                                                                                                                                                                                                                                                    } ?>>
                                                                                    Nuevo
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_edit[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Editar" <?php echo $readOnly ?> id="permiso_edit<?php echo $rowReg_c->id_menu ?>" <?php if ($chk_edit == 1) {
                                                                                                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                                                                                                } ?>>
                                                                                    Editar
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_elim[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Eliminar" <?php echo $readOnly ?> id="permiso_elim<?php echo $rowReg_c->id_menu ?>" <?php if ($chk_elim == 1) {
                                                                                                                                                                                                                                                                                        echo "checked";
                                                                                                                                                                                                                                                                                    } ?>>
                                                                                    Eliminar
                                                                                </label>
                                                                                <label class="separador">
                                                                                    <input type="checkbox" name="permiso_exportar[<?php echo $rowReg_c->id_menu ?>]" value="1" title="Exportar" <?php echo $readOnly ?> id="permiso_exportar<?php echo $rowReg_c->id_menu ?>" <?php if ($chk_exportar == 1) {
                                                                                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                                                                                            } ?>>
                                                                                    Exportar
                                                                                </label>
                                                ...
                                                <fieldset><br>
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-4 col-xs-12 col-lg-4">
                                                            <button type="submit" id="btn_guardar" style="background-color: #FFC872;" class="btn ink-reaction btn-block">
