...
<body class="<?php echo _BODY_STYLE_ ?> ">
                        ...
                        <div class="card-head style-success">
                            ...
                            <div class="tools">
                                <div class="navbar-search">
                                    <button type="button" id="btnSearch" class="btn btn-icon-toggle ink-reaction">
                                                    ...
                                                    <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0)" onclick="openMyLink(3, <?php echo $iId ?>, '<?php echo $param . 'nuevo&pag=' . $pag . $fPaginacion ?>')" class="btn ink-reaction btn-icon-toggle" data-toggle="tooltip" data-placement="top" data-original-title="Ver registro">
                                                                    <i class="fa fa-eye"> </i>
                                                                </a>
                                                                <?php
                                                                        if ($_SESSION[admin] == 1) {
                                                                            if ($isActive == 1) {
                                                                                if ($_SESSION[edit] == 1) {
                                                                                    ?>
                                                                            <a href="javascript:void(0)" onclick="openMyLink(2, <?php echo $iId ?>, '<?php echo $param . 'nuevo&pag=' . $pag . $fPaginacion ?>')" class="btn ink-reaction btn-icon-toggle" data-toggle="tooltip" data-placement="top" title="Editar Registro">
                                                                        ...
                                                                        <?php
                                                                                    ...
                                                                                    if ($_SESSION[elim] == 1) {
                                                                                        ?>
                                                                        <a onclick="handleDeleteReg(<?php echo $iId . ',' . $bajaAlta ?>)" data-toggle="tooltip" class="btn ink-reaction btn-icon-toggle" data-placement="top" title="<?php echo $titleAB ?>">
                                                                            <span class="<?php echo $icoAB ?>"></span>
                                                                        </a>

                                                                        <a onclick="handleDeleteReg(<?php echo $iId ?>, 3)" data-toggle="tooltip" class="btn ink-reaction btn-icon-toggle" data-placement="top" title="Eliminar">
    ...
    <div class="modal small fade" id="idModalSearch" 
            ...
            <div class="modal-content">
                ...
                <form role="form" id="frmSearch" class="form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group floating-label">
                                    <input type="text" class="form-control dirty" name="txtBuscar" id="idSearch" autocomplete="off" placeholder="Escribe tu término de búsqueda" />
                                    <label for="idSearch">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btnHandleSubmitSearch" class="btn ink-reaction" style="background-color: #FFC872;">
                            Realizar Búsqueda
                        </button>
                    </div>
                </form>
